...
class ProductTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_type" do
    assert_difference('ProductType.count') do
      post product_types_url, params: { product_type: { product_type: @product_type.product_type } }
    end
  ...
  test "should update product_type" do
    patch product_type_url(@product_type), params: { product_type: { product_type: @product_type.product_type } }
