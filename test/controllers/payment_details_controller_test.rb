...
class PaymentDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_detail" do
    assert_difference('PaymentDetail.count') do
      post payment_details_url, params: { payment_detail: { due_amount: @payment_detail.due_amount, order_id: @payment_detail.order_id, received_amount: @payment_detail.received_amount } }
    end
  ...
  test "should update payment_detail" do
    patch payment_detail_url(@payment_detail), params: { payment_detail: { due_amount: @payment_detail.due_amount, order_id: @payment_detail.order_id, received_amount: @payment_detail.received_amount } }
